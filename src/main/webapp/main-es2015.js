...
let PlayerEditorComponent = class PlayerEditorComponent {
    constructor(playerService, dialogRef, data) {
    ...
    createPlayer() {
        const result = new src_app_shared_models_player__WEBPACK_IMPORTED_MODULE_4__["Player"]();
        result.id = this.id;
...
PlayerEditorComponent.ctorParameters = () => [
...
let PlayerListComponent = class PlayerListComponent {
    constructor(http, playerService, dialog) {
        this.http = http;
        this.playerService = playerService;
        this.dialog = dialog;
    }
...
let PlayerViewComponent = class PlayerViewComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let PlayerService = class PlayerService {
    ...
    refreshPlayers$() {
        this.http.get('players').subscribe(players => {
